...
export const MODULE_PERMISSIONS: Record<ModuleKey, string[]> = {
  academia: ["overview", "academias", "alunos", "gestao", "crm", "agenda", "financeiro", "integracoes"],
  studio: ["overview", "studios", "academias", "alunos", "gestao", "turmas", "crm", "agenda", "financeiro", "integracoes"],
  profissional: ["overview", "meus-alunos", "minha-fila", "crm", "agenda"],
  aluno: ["overview", "meu-treino", "minhas-turmas", "agenda"],
  administrador: ["overview", "academias", "studios", "profissionais", "alunos", "gestao", "turmas", "crm", "agenda", "financeiro", "integracoes", "saas", "admin", "acervo", "configuracoes"],
};
