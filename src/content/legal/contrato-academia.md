...
Licença de uso, não exclusiva e intransferível, da plataforma ARKE (painel da Academia e aplicativo dos alunos), pelo tempo em que este Contrato vigorar.
...
Para os dados dos alunos tratados no atendimento, **a Academia é a controladora e a ArkeFit é a operadora** (LGPD, art. 5º, VI e VII). A ArkeFit se compromete a:

1. tratar os dados somente para prestar o serviço contratado e conforme as instruções da Academia registradas na plataforma;
2. manter confidencialidade, e exigir o mesmo das pessoas autorizadas a acessar os dados;
3. adotar medidas de segurança técnicas e administrativas adequadas, incluindo isolamento por academia, controle de acesso por perfil e registro de ações sensíveis;
4. usar apenas os suboperadores listados na Política de Privacidade — que a Academia autoriza de forma geral —, com obrigações equivalentes às deste Contrato, e avisar com antecedência a inclusão de novos;
5. comunicar à Academia, **em até 48 horas** da ciência, incidente de segurança que possa acarretar risco ou dano relevante aos titulares, com as informações disponíveis para que ela cumpra o seu dever de comunicação;
6. auxiliar a Academia a atender os pedidos dos titulares (acesso, correção, anonimização, eliminação, portabilidade), oferecendo as ferramentas da plataforma para isso;
