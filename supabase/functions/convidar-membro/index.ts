...
// novo aluno, personal (professor) ou nutricionista para a organização do
// gestor que chama esta função. Usado tanto pela tela de Alunos quanto pela
// de Gestão de Equipe — a diferença é só o papel e os campos extras.
